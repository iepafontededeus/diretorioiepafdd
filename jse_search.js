...
s[4] = "Oração para o Marquinho (Canta Galo 03/08/2023)^https://diretorio.iepafontededeus.com.br/03-08-2023/^Pastor levanta a igreja para orar pelo Marquinho do Canta Galo, ele pede para Deus fazer a vontade Dele.^oração";
s[5] = "Revelação para visitante de chave, e visitando os dela (Canta Galo 04/08/2023)^https://diretorio.iepafontededeus.com.br/04-08-2023/^Pastor passa revelação para visitante, que Deus iria dar uma chave na mão dela, e que Deus também vai de encontro com os dela.^revelação, chave";
...
s[8] = "Testemunho Natália casamento restituido, 7 elo restauração a dois (Perus 04/08/2023)^https://diretorio.iepafontededeus.com.br/04-08-2023/#nataliacasamentorestituido^Testemunho Irmã Natália que teve seu casamento restituido após a campanha da vida sentimental de 2023.^testemunho, campanha, amor";
s[9] = "Testemunho e revelação de emprego aonde não existia, 7 elo restauração a dois (Perus 04/08/2023)^https://diretorio.iepafontededeus.com.br/04-08-2023/#vagaondenaoexistia^Testemunho (e revelação) do irmão que o pastor disse que iria conseguir uma vaga aonde não existia.^testemunho, revelação, emprego";
s[10] = "Revelação para o obreiro Cléssio de honra na vida empresarial, 7 elo restauração a dois (Perus 04/08/2023)^https://diretorio.iepafontededeus.com.br/04-08-2023/#revelacaoclessioempresario^Pastor revelou para Cooperador Cléssio que Deus estará honrando ele e que ele irá ser bem sucedido na vida empresarial.^revelação, dinheiro";
s[11] = "Testemunho de emprego na consagração (Canta Galo 05/08/2023)^https://diretorio.iepafontededeus.com.br/05-08-2023/^Irmã dá o testemunho de emprego na consagração.^testemunho, emprego";
s[12] = "Oração final 2023, 7 elo restauração a dois (Perus 04/08/2023)^https://diretorio.iepafontededeus.com.br/04-08-2023/#oracaofinalrestadois2023^Pastor fazendo a oração final para a campanha da vida sentimental de 2023.^oração, campanha";
